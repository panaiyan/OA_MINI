<template>
  <view class="devicePlateCodeType">
    <view class="InfoBox">
      ...
      <view class="basicInfo">
        ...
        <view class="itemLine" style="width: 100%">
          VIN： <span class="eeeColor">{{ deviceInfo.p05 }}</span>
        </view>
        <view class="itemLine" style="width: 100%">
          车牌号： <span class="eeeColor">{{ deviceInfo.p03 }}</span>
        </view>
        <view class="itemLine">
          车牌类型： {{ index ? plateCodeTypes[index] : "" }}
          <picker @change="PickerChange" :value="index" :range="plateCodeTypes">
            <span class="texTColor">快速选择 </span>
          </picker>
        </view>
      </view>
